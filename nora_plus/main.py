...
MODEL = "llama3.1:8b"
MEMORY_FILE = os.path.join(SCRIPT_DIR, "chat_memory.json")
PERSONALITY_FILE = os.path.join(SCRIPT_DIR, "personality.json")
FAVORABILITY_FILE = os.path.join(SCRIPT_DIR, "favorability.json")
EMOTION_FILE = os.path.join(SCRIPT_DIR, "emotion.json")
